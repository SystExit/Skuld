...
namespace Skuld.Core
{
    public class GenericLogger
    {
        ...
        private static SkuldConfig config;

        public static void Configure(SkuldConfig con, string logfile)
        {
            config = con;
        ...
        public static void Configure(SkuldConfig con, bool OutputToConsole, bool OutputToFile, string logfile)
        {
            config = con;
            Logs = new List<LogMessage>();
        ...
        public static async Task AddToLogsAsync(LogMessage message)
        {
